...
> **현재 번역률: 2,011 / 2,048 항목 (98.2%)**
> 남은 37개는 `ALU`, `r0`, `FPS`, `Mod 4` 같은 식별자·약어라 영문을 그대로 둡니다.
...
전체 2,048 항목
├─ 번역됨  2,011 (98.2%)
└─ 미번역     37 (1.8%)  — 총 244자, 전부 식별자/약어
   ├─ campaign  27   ALU, LSR, ASR, r0~r5, Reg 0~5, Mod 4, Overture …
